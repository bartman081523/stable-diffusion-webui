...
def create_seed_inputs():
    ...
    with gr.Row(visible=False) as seed_extra_row_2:
        ...
        seed_resize_from_w = gr.Slider(minimum=0, maximum=10240, step=64, label="Resize seed from width", value=0)
        seed_resize_from_h = gr.Slider(minimum=0, maximum=10240, step=64, label="Resize seed from height", value=0)
    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    width = gr.Slider(minimum=64, maximum=10240, step=64, label="Width", value=512)
                    height = gr.Slider(minimum=64, maximum=10240, step=64, label="Height", value=512)
    ...
    with gr.Blocks(analytics_enabled=False) as img2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    width = gr.Slider(minimum=64, maximum=10240, step=64, label="Width", value=512, elem_id="img2img_width")
                    height = gr.Slider(minimum=64, maximum=10240, step=64, label="Height", value=512, elem_id="img2img_height")
        ...
        with gr.Row().style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Preprocess images"):
                    ...
                    process_width = gr.Slider(minimum=64, maximum=10240, step=64, label="Width", value=512)
                    process_height = gr.Slider(minimum=64, maximum=10240, step=64, label="Height", value=512)
                ...
                with gr.Tab(label="Train"):
                    ...
                    training_width = gr.Slider(minimum=64, maximum=10240, step=64, label="Width", value=512)
                    training_height = gr.Slider(minimum=64, maximum=10240, step=64, label="Height", value=512)
